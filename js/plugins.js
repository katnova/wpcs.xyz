  ...
  if (modules_enabled) {
    ...
    jQuery.get(module_registry + module_registry_dir + "?module=" + module, function (data, status) {
      try {
        ...
        if(json_data.registry_entry.beta) context.echo(log_level_warn + yellow("module '" + module + "' is in beta, and may cause the terminal to behave in unexpected ways. Reload the page should unexpected behavior occur."));
