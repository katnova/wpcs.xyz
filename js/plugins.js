  ...
  if (modules_enabled) {
    ...
    jQuery.get(module_registry + module_registry_dir + "?module=" + module, function (data, status) {
      try {
        ...
        if(json_data.registry_entry.beta) context.echo(log_level_warn + yellow("module '" + module + "' is in beta, and may break the terminal. Please keep this in mind when using this module."));
